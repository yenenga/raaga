...
public class FragmentListePoste extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View vue =   inflater.inflate(R.layout.fragment_liste_postel, container, false);
...
//        mRecyclerView.setAdapter(mAdapter);
        DatabaseReference posteRef = Static.getRootReference().child("Poste");
    ...
    private AdapteurPosteWithQuery getAdapter(Query requete) {

        AdapteurPosteWithQuery recyclerAdapter = new AdapteurPosteWithQuery(requete,Poste.class,getContext(),null,null);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        {//floating boutton
            ...
            final FloatingActionButton btnTypeView = (FloatingActionButton) view.findViewById(R.id.menu_item_action_type_affichage);
            //boutton ajouter produit
            btnTypeView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    if (mRecyclerView.getLayoutManager() == linearLayoutManager){
    ...
    public static Fragment newInstance() {
        return new FragmentListePoste();
    }

    public static Fragment newInstance(DatabaseReference reference) {
        FragmentListePoste fragment = new FragmentListePoste();
    ...
    private void gestionFiltre() {
        ...
        typeType.setItems(".....","Toutes categories", "Autres", "Consoles & jeux video",
...
//                    return;
//
//                requete.orderByChild("type").equalTo(typeType.getText().toString());
            }
        });
        ...
        filtreDialog.getActionButton(DialogAction.POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (typeType.getText().equals(""))
                    Toast.makeText(getContext(),".....",Toast.LENGTH_SHORT).show();
                else {
                    Query requete = Static.getRootReference().child("Poste").orderByChild("type").equalTo(String.valueOf(typeType.getText()));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            case Static.FULL_SCANNER_ACTIVITY:
                ...
                if (typeRecherche.equals(Static.TYPE_POSTE_RECHERCHER)) {
